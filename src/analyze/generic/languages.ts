 ...
 *
 * Go is here alone on purpose. A seam is worth proving on one language before it is
 * claimed for forty.
 */
...
export const LANGUAGES: GenericLanguage[] = [{ dialect: goDialect, boundaries: detectGoBoundaries }];
