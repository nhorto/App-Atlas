...
Known and unfixed, filed rather than papered over: two gitea doors still print an address that does not answer ([#60](https://github.com/nhorto/App-Atlas/issues/60)). The five-second interpreter probe that could mistake a busy machine for one with no Python on it ([#58](https://github.com/nhorto/App-Atlas/issues/58)) has since been fixed:
